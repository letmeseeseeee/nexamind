...
export function ApiUsageGuide() {
  ...
  const curlExample = `curl -X POST https://your-domain.example/api/v1/chat/completions \\
...
response = requests.post(
    "https://your-domain.example/api/v1/chat/completions",
    headers=headers,
    json=data
)
...
axios.post('https://your-domain.example/api/v1/chat/completions', data, { headers })
  .then(response => {

...
class MarkdownSplitterTest {
    ...
    void shouldProcessRealDocument() throws Exception {
        // Given - 从测试资源读取稳定的项目架构样例
        InputStream input = getClass().getResourceAsStream("/rag/nexamind-architecture-sample.md");
        ...
        System.out.println("=== 处理测试文档：nexamind-architecture-sample.md ===");
